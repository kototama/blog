...
So, to change the version of the package, you'd do example.overrideAttrs (_: { version = "0.0.2"; }) and to replace baz with some customBaz, you'd do example.override { baz = customBaz; }
...
** Debug flake and home-manager

```
flake = builtins.getFlake (toString ./.)
:p flake.nixosConfigurations.sonnfel.config.home-manager.users.neosimsim.home.sessionVariables
```
